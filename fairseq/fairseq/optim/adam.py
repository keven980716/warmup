    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                state['ratio'] = state['ratio'] * beta + (1 - beta) * 1.0
                
                step_size = state['ratio'] * group['lr'] * math.sqrt(bias_correction2) / bias_correction1
                
                #step_size = group['lr'] * math.sqrt(bias_correction2) / bias_correction1
                if group['weight_decay'] != 0:
                    p_data_fp32.add_(-group['weight_decay'] * state['ratio'] * group['lr'], p_data_fp32)
