...
def main(args, init_distributed=False):
    ...
    #model_state = checkpoint_utils.load_checkpoint_to_cpu('/home/yangwenkai/warmup/fairseq/checkpoints/IWSLT/post-norm-test/checkpoint_1_100.pt')
    #model.load_state_dict(model_state["model"], strict=True, args=args)
